export default function ReiLabel() {
  return (
    <div className="relative h-[60px] py-[48px] z-10">
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 py-[6px] px-[6px] rounded-[18px] shadow-classic"
