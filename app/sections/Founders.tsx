        ...
        >
          ...
          <div className="space-y-[48px]">
            <div className="text-center">
              ...
              >
                Our founders, seasoned real estate investors and educators,
                built the REI Institute to empower the next generation of
                certified real estate professionals. With decades of combined
                experience, they are dedicated to your success.
              </m.p>
            </div>
          ...
          <p className="sr-only">
            Meet the founders of REI Institute, experienced real estate
            investors and educators committed to empowering the next generation
